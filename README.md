# secureProgrammingCA
Hi this is my project for secure programming, a blog post app including secure and insecure versions to demonstrate various vulnerabilities and how they were fixed this is the main branch, flaw which will act as a configuration tool to properly start up the app as well as some added context
